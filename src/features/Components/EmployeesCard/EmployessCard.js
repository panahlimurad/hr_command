  ...
  return (
    <div className={styles.container}>
      ...
      <div>
        ...
        <div>
        <h3 className="text-[20px] text-[#23272C] font-medium">
            Woker Name
            </h3>
        <h5 className="text-[16px] text-[#17243E]">
            Front End Developer
            </h5>
        </div>
        <div>
      ...
      <div className="bg-[#f4f5f7] w-[95%] rounded-2xl p-4 flex flex-col gap-4">
        <div className="flex gap-4">
            <EmailIcon sx={{color:"#cbcfd4"}}/> <a className="text-[#23272C]" href="mailto:{dataGelecek}">example@gmail.com</a>
        </div>
        <div className="h-[1px] bg-[#E0E4EA]">
      ...
      <div className="w-[95%]">
        ...
        <button className="bg-[#1e74ec] text-white w-full rounded-2xl h-[40px]">View</button>
        </Link>
      </div>
    </div>
  );
