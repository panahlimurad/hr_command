...
function SmallButton({ text, method, loading, cancelMethod }) {
  return (
    <div className="text-[#fff] text-[16px] flex justify-center items-center gap-4">
      <button onClick={cancelMethod} className="bg-[#eef4fe] w-[100px] flex gap-1 items-center justify-center h-[35px] hover:bg-[#e4e9f2] rounded-lg text-[#1e74ec]">
